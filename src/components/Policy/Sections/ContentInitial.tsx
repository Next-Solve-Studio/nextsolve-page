...
export default function ContentInitial() {
    ...
    return (
        <section className="relative w-full py-20 md:py-28 bg-[#050505] overflow-hidden px-6 border-b border-white/5">
            ...
            <div className="max-w-6xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-4 items-center">
                <div className="text-center lg:text-left" data-aos="fade-right">
                    ...
                    <h1 className="font-syne font-black text-4xl sm:text-5xl lg:text-6xl text-white leading-[1.1] tracking-tight mb-6">
                        Política de <br />
                    ...
                    <p className="text-gray-400 text-base md:text-lg font-light leading-relaxed max-w-xl mx-auto lg:mx-0">
                        Segurança, transparência e engenharia de conformidade. Saiba como a
                        <p className="text-white font-medium font-mono text-sm"> NextSolve /</p>
                        protege, processa e respeita os seus ativos digitais e informações.
                    </p>
                ...
                <div className="flex justify-center lg:justify-center relative" data-aos="fade-left" data-aos-delay="200">
